...
BUILD_PRELOADER = yes
BUILD_UBOOT = no
CUSTOM_BUILD_VERNO = CY-BRADY-K8
...
CUSTOM_HAL_CAM_CAL = fm24c64d s5k3m3_eeprom GT24c64 imx376_eeprom
CUSTOM_HAL_COMBO = mt6757
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = imx386_mipi_raw s5k3m3_mipi_raw s5k3p8sp_mipi_raw s5k3p8spb_mipi_raw imx376_mipi_raw
CUSTOM_HAL_LENS = ak7371af dw9714af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR = s5k3m3_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_HAL_MAIN_IMGSENSOR = imx386_mipi_raw
CUSTOM_HAL_MAIN_LENS = ak7371af
...
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p8sp_mipi_raw s5k3p8spb_mipi_raw imx376_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = fm24c64d s5k3m3_eeprom GT24c64 imx376_eeprom
...
CUSTOM_KERNEL_IMGSENSOR = imx386_mipi_raw s5k3m3_mipi_raw s5k3p8sp_mipi_raw s5k3p8spb_mipi_raw imx376_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = ak7371af dw9714af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = s5k3m3_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9714af
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx386_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = ak7371af
CUSTOM_KERNEL_PDR_SENSOR = no
CUSTOM_KERNEL_PEDOMETER = no
CUSTOM_KERNEL_PICK_UP_SENSOR = no
CUSTOM_KERNEL_RGBW = no
...
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p8sp_mipi_raw s5k3p8spb_mipi_raw imx376_mipi_raw
...
#modify by zhuyiqun for fingerprint TEE 2017-7-5 start
MICROTRUST_TEE_SUPPORT = yes
#modify by zhuyiqun for fingerprint TEE 2017-7-5 end
...
#add by zhuyiqun for foursemi smartpa start
MTK_AUDIO_SPEAKER_PATH_TWO = smartpa_foursemi_fs16xx
#add by zhuyiqun for foursemi smartpa end
...
#modify zhuyiqun XLLEHJQEN-1070 2017-8-24 start
MTK_BESLOUDNESS_SUPPORT = no
#modify zhuyiqun XLLEHJQEN-1070 2017-8-24 end
...
MTK_BUILD_VERNO = BRADY-K8-171227V175
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#delete chenlijia start
#MTK_ETWS_SUPPORT = yes
#delete chenlijia end
...
MTK_IRAT_SUPPORT = no
# disable IRTX by wgx start
MTK_IRTX_PWM_SUPPORT = no
MTK_IRTX_SUPPORT = no
# disable IRTX by wgx end
...
#zhanyang.duan 20170524 begin
MTK_MD_SBP_CUSTOM_VALUE = 0
#zhanyang.duan 20170524 end
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_kernel_4-4
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = no
# enable usb2uart by wgx start
MTK_UART_USB_SWITCH = no
# enable usb2uart by wgx end
MTK_UIPQ_SUPPORT = no
...
#board: modify by vendor team for Brady 20170809 begin
MTK_WFD_SINK_SUPPORT = yes
MTK_WFD_SINK_UIBC_SUPPORT = yes
#board: modify by vendor team for Brady 20170809 end
MTK_WFD_SUPPORT = yes
...
#CREATE_PROJECT_INFO=20170414234247
#add chenlijia start
BUILD_GMS = yes
BUILD_3RDPARTY = yes
#transsion.device.name
RLK_DEVICE_NAME = Lenovo K8
OS_VERSION = v3.0
RLK_XOS_PATCH_ID = XOSP64-V3.0.251-P2-171207
RLK_LAZADA_SUPPORT = no
RLK_DUALAID_SUPPORT = yes
RLK_WHATSAPP_SUPPORT = yes
RLK_PROJECT_NAME = brady_k8
RLK_PROJECT = lenovo_brady
XUI_REALLYTEK_COMPASS = yes
RLK_SUPPORT_DUO = yes
#Hall start
RLK_HALL_SUPPORT = yes
RLK_HALL_STYLE = 3
RLK_HALL_WIDTH = 1080
RLK_HALL_HEIGHT = 1964
#Hall end
...
#OTG start
OS_OTG_NO_CHARGE = yes
#OTG end

#Single hand start
OS_SYSTEMUI_SINGLE_HAND_SUPPORT = yes
#Single hand end
#LED start
RLK_LED_LIGHT_SUPPORT = yes
RLK_LED_SWITCH_SUPPORT = yes
#LED end

#add yangyong 20170704 RIJO start
MTK_SIP_SUPPORT = no
#add yangyong 20170704 RIJO end

#Flashlight start
OS_THREE_FLASHLIGHT_SUPPORT = no
#Flashlight end

OS_WALLPAPERPICKER_SUPPORT = no
#india incall start 
MTK_INDIA_INCALL_SUPPORT = yes
#india incall end

#phone master support start
OS_PHONE_MASTER_SUPPOERT = yes
#phone master support end

#my_ZG inputmethod touchpal start 
RLK_ZAWGYIPACK_SUPPORT = yes
#my_ZG inputmethod touchpal end 

OS_NEW_LED_SUPPORT = yes
#Packsell support start
#RLK_PACKSELL_SUPPORT = yes
#Packsell support end
#RLK_DARAZ_SUPPORT = yes
OS_DEMO_MODE_SUPPORT = no
RLK_WHATSAPP_STUB_SUPPORT = yes
RLK_PHOENIX_UNINSTALL_AVAILABLE_SUPPORT = yes
RLK_USERGUIDE_UNINSTALL_AVAILABLE_SUPPORT = yes
#add chenlijia end
# add by rui.zhang for fingerprint start
#FINGERPRINT_SUPPORT_SW9261 = yes
FINGERPRINT_SUPPORT_SW9251_TEE = yes
# add by rui.zhang for fingerprint end
# add by wgx for transsion project definition
#============================================================
#zhangpj 20170316@add for transsion camera feature begin
RLK_CAMERA_FEATURE =yes
RLK_CAMERA_FACEBEAUTY = yes
RLK_CAMERA_LOWLIGHT = yes
RLK_CAMERA_SUPERPHOTO = no
RLK_CAMERA_FRONT_MIRROR = yes
RLK_CAMERA_USE_PERFSERVICE = yes
RLK_CAMERA_FILTER = no
RLK_CAMERA_LOWLIGHT_FACEBEAUTY = yes
RLK_CAMERA_AUTO_LOGO = yes
RLK_CAMERA_ASD = yes
RLK_CAMERA_DRO = yes
RLK_SINGLE_FRM_DENOISE = no
RLK_CAMERA_NIGHTHAWK = yes
RLK_CAMERA_ARC_LOWLIGHT = yes
RLK_CAMERA_PICSELFIE_BEAUTY = yes
#zhangpj 20170316@add for transsion camera feature end
#============================================================
CUSTOM_TRANSSION_PROJECT = CONFIG_BRADY_K8
#rlk_yazhou_add_for_RGB_S
RLK_RGBW_SENSOR_SUPPORT = yes
#rlk_yazhou_add_for_RGB_e
MTK_CAM_GESTURE_SUPPORT = yes
MTK_CAM_SD_SUPPORT = yes
#add by caizhaohui for midtest start
RLK_MIDTEST_SUPPORT = yes
RLK_THRID_CAMERA_SUPPORTED = yes
RLK_MD_NXP_SMARTPA_SUPPORT = smartpa_nxp_tfa98xx
RLK_MD_NXP_SMARTPA_FS16XX_SUPPORT = smartpa_foursemi_fs16xx
RLK_MD_COLOR_TEMP_SUPPORT = yes
MD_DUAL_CAMERA_SUPPORT = yes
#add by caizhaohui for midtest end
#ADD [PPD] qiong.wang 2017.02.05 remove wakelock
RLK_REMOVE_WAKELOCK_SUPPORT = yes
#end

#PPD
RLK_PNPMGR_SUPPORT = yes
ENABLE_CPUSETS = yes
#[PPD] Atrace monitor, START @{
RLK_ATRACE_MONITOR_SUPPORT = no
SUPPORT_CONN_WITH_UI = no
CONFIG_LOG_BUF_SHIFT=23
#[PPD] Atrace monitor, END @}
#+++++++++add by yazhou for camera manual start+++++++++++
RLK_CAMERA_MANUAL_AF_SUPPORT = yes
RLK_CAMERA_MANUAL_SHUTTER_SUPPORT = yes
RLK_CAMERA_MANUAL_AE_METERING_SUPPORT = yes
#+++++++++add by yazhou for camera manual end ++++++++++++
#wei.miao@reallytek.com add for customize feature 20170713 start
RLK_CAMERA_CUSTOMIZE_FEATURE = yes
#end
#wei.miao@reallytek.com add for front flashlight level 20170713 start
RLK_CAMERA_FRONT_FLASHLIGHT_LEVEL_SUPPORT = yes
#end
#wei.miao@reallytek.com modify for thirdpart apk dark 20170725:AXQHWQY-2120
RLK_CAMERA_THIRDPART = yes
#end
#Camera3.0 add start
ARCSOFT_BURST_SUPPORT = yes
#end

#ADD [PPD] mingyuan.wang 2017.07.07  (start)
#if you close lucid, remove the comment # below
#LUCID_DISABLED = 1
#LUCID_DISABLED2 = 1
#ADD [PPD] mingyuan.wang 2017.07.07 (end)

#[PPD] ProcessManager start @{
PROCESS_MANAGER_SUPPORT=yes
#[PPD] ProcessManager end @}

#[PPD] lowmemorykiller_boost start @{
LMK_BOOST_SUPPORT=no
#[PPD] lowmemorykiller_boost end @}

#board: add DEVICE_INFO by vendor team 20170727 start
OS_QUICK_CHARGE = yes
OS_CAMERA_REAR = 12M+13M
OS_CAMERA_FRONT = 16M
OS_SCREEN_SIZE = 5.98
OS_CPU_FREQ = 2.6
#board: add DEVICE_INFO by vendor team 20170727 end

#ADD [PPD] mingyuan.wang 2017.04.13 PPS (start)
MTK_PPS_SUPPORT = yes
#ADD[PPD] mingyuan.wang 2017.04.13 PPS (end)

#add UserGuide-liuhaojie start
RLK_USERGUIDE_VERSION = brady_k8_n
#add UserGuide-liuhaojie end

#ppd
RLK_USE_F2FS = yes
#add jinbaoping start 20171024
RLK_CAMERA_COLOUR_VERSION=yes
